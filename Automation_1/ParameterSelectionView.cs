...
namespace ParameterSetter
{
    ...
    internal class ParameterSelectionView : Dialog, IParameterSelectionView
    {
        ...
        {
            Title = "Select Parameter ID";

            ParameterIdNumeric = new Numeric();
            BackButton = new Button("Back...");
            ContinueButton = new Button("Continue...");

            ParameterIdNumeric.StepSize = 1;

            AddWidget(ParameterIdNumeric, 1, 1, 1, 1);
            AddWidget(BackButton, 3, 1, 1, 1);
            AddWidget(ContinueButton, 3, 2, 1, 1);
        }
